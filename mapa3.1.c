...
void solicitarAtendimento(struct atendimento atendimentos[], int *contadorAtendimentos) {
    ...
    do {
        ...
        if (atendimentos[*contadorAtendimentos].tipoAtendimento < 1 || atendimentos[*contadorAtendimentos].tipoAtendimento > 4) {
            printf("Op?ão inválida. Tente novamente.\n");
        }

    } while (atendimentos[*contadorAtendimentos].tipoAtendimento < 1 || atendimentos[*contadorAtendimentos].tipoAtendimento > 4);
